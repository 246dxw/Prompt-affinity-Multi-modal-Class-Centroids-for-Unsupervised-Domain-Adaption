...
class PMCC(BaseDA):
    ...
    def construct_bank(self):
        ...
        print(f"Construct Elapsed: {str(elapsed)}")
    ...
    def T_SNE_combined(self):
        ...
        last_three_chars = out_dir[-11:-8]
        last_three_chars_upper = last_three_chars.upper()
        print(out_dir + '/PMCC' + ' (' + last_three_chars_upper + ')' + '.pdf')
        plt.title('PMCC' + ' (' + last_three_chars_upper + ')', fontdict={"family": "Times New Roman", "size": 64})

        plt.savefig(out_dir + '/PMCC' + ' ('+ last_three_chars_upper +')' + '.pdf')
